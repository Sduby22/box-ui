...
- **Keep AGENTS.md in sync**: When a modification changes the project structure, tech stack, features, or development conventions described in this file, update AGENTS.md accordingly to keep it accurate.
